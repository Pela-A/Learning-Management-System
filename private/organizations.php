            ...
            <?php elseif($action == 'Edit'):
                ...
                <form method="post" action="organizations.php?action=Viewer" name="Organization_CRUD">
                    ...
                    <div style="display:flex;">
                        ...
                        <input class="form-control btn btn-light m-2" type="submit" name="delete" value="Delete Organization">
                ...
                <a href="organizations.php?action=Viewer">
                    <button class="form-control btn btn-light m-2">Go Back</button>
                </a>
